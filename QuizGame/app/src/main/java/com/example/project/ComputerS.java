...
public class ComputerS extends AppCompatActivity {
    ...
    RecyclerAdapterCom adapter; // Use the specific adapter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapterCom(); // Initialize with questions
        ...
        move.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(ComputerS.this, MainActivity2.class);
        ...
        move2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputerS.this, Finish.class);
