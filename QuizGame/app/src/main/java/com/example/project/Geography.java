...
public class Geography extends AppCompatActivity {
    ...
    RecyclerAdapterGeo adapter; // Use the specific adapter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapterGeo(); // Initialize with questions
        ...
        move.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Geography.this, MainActivity2.class);
        ...
        move2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Geography.this, Finish.class);
